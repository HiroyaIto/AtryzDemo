    ...
    Private Sub SerialPort1_DataReceived(sender As Object, e As SerialDataReceivedEventArgs) Handles SerialPort1.DataReceived
        ...
        While SerialPort1.BytesToRead > 0
            ...
            If (data_out_res = 1) Then
                ...
                Dim byteArray_useful2() As Byte = {buf_chk(32), buf_chk(31), buf_chk(30), buf_chk(29), buf_chk(28), buf_chk(27), buf_chk(26), buf_chk(25)}
                ...
                Dim byteArray_average2() As Byte = {buf_chk(23), buf_chk(22), buf_chk(21), buf_chk(20), buf_chk(19), buf_chk(18), buf_chk(17), buf_chk(16)}
                ...
                Dim byteArray_diff2() As Byte = {buf_chk(14), buf_chk(13), buf_chk(12), buf_chk(11), buf_chk(10), buf_chk(9), buf_chk(8), buf_chk(7)}
                ...
                'LED_ON_OFF = System.Text.Encoding.ASCII.GetString(buf_chk(3))
                LED_ON_OFF2 = Chr(buf_chk(5))

                'Dim singleByte As Byte = 72
                'Dim result As String = Chr(singleByte)

                If buf_chk(5) = &H34 Then
                    ＇g.FillEllipse(brush, 0, 0, bmp.Width, bmp.Height)
