...
        'Me.TextBox1.Text &= dat & " "
    ...
    Dim Dispz0A(40) As Short  '2024.11.19
    Dim Dispy0A(40) As Short  '2024.11.19
    Dim Dispx0A(40) As Short  '2024.11.19
    ...
    Private Sub SerialPort1_DataReceived(sender As Object, e As SerialDataReceivedEventArgs) Handles SerialPort1.DataReceived
        ...
        While SerialPort1.BytesToRead > 0
            ...
            If (count_32 = 0) Then
                ...
                ＇LED on-offの状態をfileへ書き込み用
                Dim LED_ON_OFF As String
                'LED_ON_OFF = System.Text.Encoding.ASCII.GetString(buf_chk(3))
                LED_ON_OFF = Chr(buf_chk(3))
                ...
                Else
                    ...
                    g.FillEllipse(brushRed, 0, 0, bmp.Width, bmp.Height)
                    g.DrawEllipse(Pens.Black, 0, 0, bmp.Width - 1, bmp.Height - 1)
                    PictureBox4.Image = bmp
                End If
                ...
                If (fileflg = 1) Then
                    ...
                    disp_recv_str_log3 = disp_recv_str_log3 & "," & asciiString_useful & "," & asciiString_average & "," & asciiString_diff & "," & LED_ON_OFF
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        If fileflg = 0 Then
            ...
            disp_recv_str_log = disp_recv_str_log & " " & "," & "     useful" & "," & "   average" & "," & "          diff " & "," & "          LED " & vbCrLf
            Writer.Write(disp_recv_str_log)
